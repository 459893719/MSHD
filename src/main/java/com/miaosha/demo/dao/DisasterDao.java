...
public interface DisasterDao {
    @Insert("INSERT INTO commdisaster(`ID`, `date`, `location`, `type`, `grade`, `picture`,`note`, `reporting unit`) VALUES " +
    ...
    @Insert({
     "<script>",
     "INSERT INTO commdisaster(`ID`, `date`, `location`, `type`, `grade`, `picture`,`note`, `reporting unit`) VALUES",
