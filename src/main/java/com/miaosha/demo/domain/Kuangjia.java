...
public class Kuangjia {
	...
	public Kuangjia(String key, String id, String date, String location, String basically_intact_square,
	...
	public String toString() {
		return "Kuangjia [key=" + key + ", id=" + id + ", date=" + date + ", location=" + location
