...
public class Zhuanmu {
	...
	public Zhuanmu(String key, String id, String date, String location, String basically_intact_square,
	...
	public String toString() {
		return "Zhuanmu [key=" + key + ", id=" + id + ", date=" + date + ", location=" + location
