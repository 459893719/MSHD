...
public class FangwuQita {
	...
	public FangwuQita(String key, String id, String date, String location, String basically_intact_square,
	...
	public String toString() {
		return "FangwuQita [key=" + key + ", id=" + id + ", date=" + date + ", location=" + location
