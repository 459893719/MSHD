...
public class Dianli {
    ...
    public Dianli(String key, String id, String date, String location, String type, String grade, String picture, String note, String reporting_unit) {
        this.key = key;
    	this.id = id;
        this.date = date;
	...
	public String toString() {
		return "Dianli [key=" + key + ", id=" + id + ", date=" + date + ", location=" + location + ", type=" + type
